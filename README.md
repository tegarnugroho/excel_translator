<h1 align="center">excel_translator</h1>

<p align="center">
  <em>Type-safe Flutter &amp; Dart localizations, generated from a spreadsheet.</em>
</p>

<p align="center">
  <a href="https://pub.dev/packages/excel_translator"><img src="https://img.shields.io/pub/v/excel_translator.svg" alt="pub package"></a>
  <a href="https://opensource.org/licenses/MIT"><img src="https://img.shields.io/badge/license-MIT-purple.svg" alt="License: MIT"></a>
  <a href="https://dart.dev"><img src="https://img.shields.io/badge/dart-%3E%3D3.8.0-blue" alt="Dart SDK"></a>
</p>
...
<details>
<summary><strong>Why build_runner cannot emit per-sheet files</strong></summary>
...
Yes — `--class-name=MyL10n`, or `class_name: MyL10n` in `pubspec.yaml`.
...
Excel / CSV / ODS
       │
       ▼  FileParserFactory.createParser()      selects by extension
  FileParser.parseFile()
       │                                        → List<LocalizationSheet>
       ▼  SheetClassGenerator · MainClassGenerator · ExtensionGenerator
       │
